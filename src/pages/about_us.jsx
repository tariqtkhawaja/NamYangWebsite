      ...
      <div className="about-container">
        ...
        <section className="our-team">
          ...
          <p className="sam-byford-winter">
            ...
            <p className="description">Sam has been training in Martial Arts and Combat Sports for over 20 years. He manages Nam Yang Brighton and Hove branches and runs all the Kickboxing programs, Teens Kung Fu, Junior programs and Little Tigers as well as our community outreach work. If that wasn’t enough, he’s also our competition team head coach.</p>
            <img
              input
              type="image"
          ...
          <p className="finn-hayes">
            ...
            <p className="description">
              Finn started his Martial Arts training as a child in Karate. He’s been training at Nam Yang for over 4 years and has represented the club many times, including two National titles at Kickboxing and Savate competitions. Finn is the manager at Nam Yang Worthing and regularly teaches and attends classes at Nam Yang Brighton
            </p>
            <img
              input-type="image"
              className="fit-picture"
              ...
              <div className="instructor-container">
               <p className="christina-jo-saunders">
